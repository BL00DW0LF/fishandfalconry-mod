...
public class EntityBaitedHook extends EntityFishHook
{
    ...
    public EntityBaitedHook(World par1World)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
    ...
    @SideOnly(Side.CLIENT)
    public EntityBaitedHook(World par1World, double par2, double par4, double par6, EntityPlayer par8EntityPlayer)
    {
        this(par1World);
    ...
    public EntityBaitedHook(World par1World, EntityPlayer par2EntityPlayer)
    {
        super(par1World);
        this.xTile = -1;
        this.yTile = -1;
